        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Perusahaan</h1>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Perbarui data perusahaan</p>
                    </div>
            ...
            <form action="{{ route('superadmin.companies.update', $company) }}" method="POST" class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="alamat" 
                              ...
                              placeholder="Masukkan alamat lengkap perusahaan (opsional)">{{ old('alamat', $company->alamat) }}</textarea>
                    @error('alamat')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
