{{-- Blok I: Keterangan Umum - Read-only partial for survey detail view --}}
                ...
                <div class="form-row">
                    ...
                    <div class="radio-group">
                        <div class="radio-option">
                            <input type="radio" name="jenis_kawasan" value="ekonomi_khusus"
                        ...
                        <div class="radio-option">
                            <input type="radio" name="jenis_kawasan" value="industri"
                        ...
                        <div class="radio-option">
                            <input type="radio" name="jenis_kawasan" value="luar_kawasan"
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-row">
                    ...
                    <div class="radio-group">
                        <div class="radio-option">
                            <input type="radio" name="legalisasi_jenis_kelamin" value="laki_laki"
                                   {{ ($surveyResponse->legalisasi_jenis_kelamin ?? '') == 'laki_laki' ? 'checked' : '' }}
                                   class="radio-input" readonly disabled>
                            <label class="radio-label">Laki-laki</label>
                        </div>
                        <div class="radio-option">
                            <input type="radio" name="legalisasi_jenis_kelamin" value="perempuan"
        ...
        <div class="form-section" style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.05), rgba(37, 99, 235, 0.05));">
            ...
            <div class="form-grid">
                ...
                <div class="form-row">
                    ...
                    <span class="form-control" style="background: transparent; border: none; padding: var(--spacing-3) 0;">{{ $bpsRiData['penghubung'] ?? 'Tim Statistik Industri' }}</span>
                </div>
                ...
                <div class="form-row">
                    ...
                    <span class="form-control" style="background: transparent; border: none; padding: var(--spacing-3) 0;">{{ $bpsRiData['telepon'] ?? '021-3810291 ext. 5310-5313' }}</span>
                </div>
                ...
                <div class="form-row">
                    ...
                    <span class="form-control" style="background: transparent; border: none; padding: var(--spacing-3) 0;">{{ $bpsRiData['fax'] ?? '021-3863816, 021-3857046' }}</span>
                </div>
                ...
                <div class="form-row">
                    ...
                    <span class="form-control" style="background: transparent; border: none; padding: var(--spacing-3) 0;">{{ $bpsRiData['email'] ?? 'ibs@bps.go.id' }}</span>
                </div>
                ...
                <div class="form-row">
                    ...
                    <span class="form-control" style="background: transparent; border: none; padding: var(--spacing-3) 0;">{{ $bpsRiData['alamat'] ?? 'Jl. Dr. Sutomo No. 8, Jakarta 10710' }}</span>
                </div>
            </div>
        </div>
    </form>
