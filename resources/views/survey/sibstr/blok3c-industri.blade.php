...
@section('title', 'SIBSTR — Blok IIIC: Bahan Baku & Bahan Penolong')
...
@include('survey.sibstr.partials.page-head', [
    'blokTitle' => 'Blok IIIC — Bahan Baku & Bahan Penolong',
    'blokSub'   => 'Pemakaian dalam negeri & luar negeri',
])
<div class="survey-container">
    @include('survey.sibstr.partials.blok-toolbar', [
        'instruction' => '<strong>Petunjuk:</strong> Isi semua bahan baku dan bahan penolong yang digunakan. Klik <em>Tambah Bahan</em> untuk menambah baris baru, dan klik judul kartu untuk membuka/menutupnya.',
    ])
