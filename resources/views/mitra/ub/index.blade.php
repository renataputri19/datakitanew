...
@section('title', 'Hasil Survei UB - Mitra')
@section('description', 'Daftar respons Survei Unit Bisnis/Usaha Baru (SE2026-L.UB) dari seluruh pengguna')
...
<div class="space-y-6">
    ...
    <div class="flex items-start justify-between gap-4 flex-wrap">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Hasil Survei UB</h1>
    ...
    <div class="ub-filter-section">
        <form method="GET" action="{{ route('survey.ub.entry') }}" class="space-y-4">
            ...
            <div class="flex gap-2 flex-wrap">
                ...
                <a href="{{ route('survey.ub.entry') }}" class="btn-reset">
        ...
        @if($surveyResponses->count() > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex; gap:0.375rem; flex-wrap:wrap;">
                                    <a href="{{ route('survey.mitra.ub.show', $resp->id) }}" class="btn-view">
                                    ...
                                    <a href="{{ route('survey.mitra.ub.download', $resp->id) }}"
                                       class="btn-view"
            ...
            <div class="pagination-container">
                <div class="text-sm text-gray-600 dark:text-gray-400">
                    Menampilkan {{ $surveyResponses->firstItem() }}&ndash;{{ $surveyResponses->lastItem() }} dari {{ $surveyResponses->total() }} hasil
                </div>
        ...
        @else
            <div class="empty-state">
                ...
                <p class="text-gray-600 dark:text-gray-400">
                    ...
                    @else
                        Belum ada respons Survei UB yang tersedia.
                    @endif
                </p>
            </div>
        @endif
