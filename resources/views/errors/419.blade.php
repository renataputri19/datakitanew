...
<head>
    ...
    <title>419 – Sesi Kedaluwarsa | DataKita</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 flex items-center justify-center px-4 py-16">
            <div class="max-w-md w-full text-center">
                <!-- Icon -->
                <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-orange-50 dark:bg-orange-900/20">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-orange-500 dark:text-orange-400" fill="none"
                ...
                <!-- Code -->
                <p class="text-sm font-semibold uppercase tracking-widest text-orange-500 dark:text-orange-400 mb-2">
                    Error 419
                </p>
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                    Sesi halaman Anda telah kedaluwarsa karena tidak aktif terlalu lama atau token keamanan
                    tidak valid. Silakan muat ulang halaman dan coba lagi.
                </p>
