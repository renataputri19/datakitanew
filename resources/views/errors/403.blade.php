...
<head>
    ...
    <title>403 – Akses Ditolak | DataKita</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 flex items-center justify-center px-4 py-16">
            <div class="max-w-md w-full text-center">
                ...
                <!-- Code -->
                <p class="text-sm font-semibold uppercase tracking-widest text-red-500 dark:text-red-400 mb-2">
                    Error 403
                </p>
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                    Anda tidak memiliki izin untuk mengakses halaman ini. Jika Anda merasa ini adalah
