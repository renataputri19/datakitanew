...
<head>
    ...
    <title>401 – Akses Tidak Diizinkan | DataKita</title>
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="flex-1 flex items-center justify-center px-4 py-16">
            <div class="max-w-md w-full text-center">
                <!-- Icon -->
                <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-yellow-50 dark:bg-yellow-900/20">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-yellow-500 dark:text-yellow-400" fill="none"
                ...
                <!-- Code -->
                <p class="text-sm font-semibold uppercase tracking-widest text-yellow-600 dark:text-yellow-400 mb-2">
                    Error 401
                </p>
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                    Anda perlu masuk ke akun terlebih dahulu untuk mengakses halaman ini.
                    Silakan login dengan kredensial yang valid dan coba kembali.
                </p>
