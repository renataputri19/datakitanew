...
<head>
    ...
    <title>500 – Kesalahan Server | DataKita</title>
        ...
        <main class="flex-1 flex items-center justify-center px-4 py-16">
            <div class="max-w-md w-full text-center">
                ...
                <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-gray-500 dark:text-gray-400" fill="none"
                ...
                <!-- Code -->
                <p class="text-sm font-semibold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-2">
                    Error 500
                </p>
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                    Maaf, server kami sedang mengalami masalah teknis. Tim kami sedang bekerja untuk
                    memperbaikinya. Silakan coba kembali beberapa saat lagi.
                </p>
