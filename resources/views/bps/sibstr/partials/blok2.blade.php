        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-row">
                    ...
                    <div class="form-subgrid">
                        <div class="form-subrow">
                            <label class="form-sublabel">a. Jumlah pekerja menurut jenis kelamin:</label>
                            <div class="form-subgrid">
                                <div class="form-subrow">
                                    <label class="form-sublabel">- Pekerja Laki-laki:</label>
                                    <input type="number" name="tenaga_kerja_laki_laki" value="{{ $surveyResponse->tenaga_kerja_laki_laki ?? '' }}"
                                           class="form-control" readonly disabled>
                                </div>
                                <div class="form-subrow">
                                    <label class="form-sublabel">- Pekerja Perempuan:</label>
                                    <input type="number" name="tenaga_kerja_perempuan" value="{{ $surveyResponse->tenaga_kerja_perempuan ?? '' }}"
                                           class="form-control" readonly disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-subrow">
                            ...
                            <div class="form-subgrid">
                                <div class="form-subrow">
                                    ...
                                    <input type="number" name="tenaga_kerja_produksi" value="{{ $surveyResponse->tenaga_kerja_produksi ?? '' }}"
                                           class="form-control" readonly disabled>
                                </div>
                                <div class="form-subrow">
                                    <label class="form-sublabel">- Pekerja lainnya:</label>
                                    <input type="number" name="tenaga_kerja_lainnya" value="{{ $surveyResponse->tenaga_kerja_lainnya ?? '' }}"
                                           class="form-control" readonly disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-subrow">
                            ...
                            <input type="number" name="tenaga_kerja_asing" value="{{ $surveyResponse->tenaga_kerja_asing ?? '' }}"
                                   class="form-control" readonly disabled>
                        </div>
                        <div class="form-subrow">
                            <label class="form-sublabel">d. Jumlah pekerja outsourcing:</label>
                            <input type="number" name="tenaga_kerja_outsourcing" value="{{ $surveyResponse->tenaga_kerja_outsourcing ?? '' }}"
                                   class="form-control" readonly disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-subgrid">
                        ...
                        <div class="form-subrow">
                            <label class="form-sublabel">b. KBLI utama (5 digit):</label>
                            <input type="text" name="kbli_utama" value="{{ $surveyResponse->kbli_utama ?? '' }}"
                                   class="form-control" readonly disabled>
                        </div>
                    </div>
                </div>
