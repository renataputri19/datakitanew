...
@section('title', 'Data Survei UB - BPS Dashboard')
@section('description', 'Daftar semua respons Survei Unit Bisnis/Usaha Baru (SE2026-L.UB)')
...
<div class="space-y-6">
    ...
    <div class="flex items-start justify-between gap-4 flex-wrap">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Data Survei UB</h1>
    ...
    <div class="ub-filter-section">
        <form method="GET" action="{{ route('bps.ub.index') }}" class="space-y-4">
            ...
            <div class="flex gap-2 flex-wrap">
                ...
                <a href="{{ route('bps.ub.index') }}" class="btn-reset">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display:flex; gap:0.375rem; flex-wrap:wrap;">
                                    <a href="{{ route('bps.ub.show', $resp->id) }}" class="btn-view">
                                    ...
                                    <a href="{{ route('bps.ub.download', $resp->id) }}"
                                       class="btn-view"
                                    ...
                                    <button type="button" class="btn-delete"
                                            title="Hapus data survei UB ini"
                                            onclick="bpsConfirmDelete(
                                                '{{ route('bps.ub.destroy', $resp->id) }}',
                                                @js($resp->nama_perusahaan ?: ($resp->user->name ?? 'Responden')),
                                                @js('Survei UB — ' . ($resp->user->email ?? '')),
                                                @js('Survei UB')
                                            )">
                                        <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
