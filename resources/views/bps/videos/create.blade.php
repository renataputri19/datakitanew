...
@section('title', 'Tambah Video - BPS Dashboard')
@section('description', 'Halaman tambah video BPS Kota Batam')

@section('content')
    <div class="bps-card">
        <div class="bps-card-header">
            <h1 class="bps-title">Tambah Video</h1>
        ...
        <div class="bps-card-body">
            <form action="{{ route('bps.videos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="url" id="url" value="{{ old('url') }}" class="bps-input pl-10" required placeholder="https://www.youtube.com/watch?v=..." onchange="previewYouTubeThumbnail(this.value)">
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                                <p>Jika Anda tidak mengunggah thumbnail, sistem akan menggunakan thumbnail default dari platform video (misalnya YouTube).</p>
                            </div>
                        </div>
                    </div>
                </div>
