            ...
            <div class="mx-auto grid max-w-5xl grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 py-4 md:py-8">
                ...
                <div class="relative overflow-hidden rounded-xl border-2 border-blue-100 dark:border-gray-800 bg-white dark:bg-gray-950 transition-all duration-300 hover:border-blue-600 dark:hover:border-blue-500 hover:shadow-xl group" data-aos="fade-up" data-aos-delay="450">
                    ...
                    <div class="p-5 md:p-6">
                        ...
                        <a href="{{ route('survey.sibstr.blok1') }}" class="inline-flex items-center text-blue-600 dark:text-blue-500 hover:underline group-hover:font-medium transition-all duration-300">
    ...
    <section class="py-12 md:py-16 lg:py-20 bg-blue-600 text-white relative overflow-hidden">
        <div class="container mx-auto px-4 md:px-6 relative z-10">
            <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="text-center md:text-left space-y-4 md:w-2/3" data-aos="fade-right">
                    <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold">Butuh Data Statistik?</h2>
                    <p class="text-base md:text-lg text-blue-100">Konsultasikan kebutuhan data Anda dengan Encik Bot</p>
                </div>
                <div class="md:w-1/3 flex justify-center md:justify-end" data-aos="fade-left">
                    <a href="http://wa.me/6281319992171" target="_blank" class="inline-flex items-center justify-center rounded-full bg-white text-blue-600 hover:bg-blue-50 px-6 py-3 font-medium text-base md:text-lg transform hover:scale-105 hover:shadow-lg transition-all duration-300">
        ...
        <div class="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-blue-500 rounded-full opacity-50"></div>
        <div class="absolute bottom-0 left-0 -mb-10 -ml-10 w-40 h-40 bg-blue-700 rounded-full opacity-50"></div>
    </section>
@endsection
